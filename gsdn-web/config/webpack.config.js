...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      ...
      // There will be one GlobalStyle bundle, and one file per asynchronous chunk.
    ...
    resolve: {
      ...
      alias: {
        ...
        '@utils':paths.utils,
        '@utilsComponents':paths.utilsComponents
      },
      plugins: [
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            // Comment missing `test` is equivalent to a match.
            {
